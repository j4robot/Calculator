...
class DataInputDisplay extends React.Component{
  render(){
    return(
      <View style={style.result}><Text style={style.resultText}>{this.props.text}</Text></View>)
  }
}
...
const style = StyleSheet.create({
  ...
  btnText: {fontSize: 30, },
  result: { flex: 2, backgroundColor: '#FFF', justifyContent: 'center', alignItems: 'flex-end' },
  ...
  resultText:{fontSize: 30, color: '#000'},
